(function () {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    async function saveBlotter(ev) {
      ...
      const respondent = (id('respondent') && id('respondent').value.trim()) || '';
      ...
      if (editId) {
        ...
        entry.complainant = complainant; entry.location = location; entry.respondent = respondent;
        ...
        const newEntry = {
          id: Date.now(),
          caseNo: cno,
          complainant, location, respondent, incidentType, incidentDate, narrative, evidence, status,
    ...
    function openViewModal(rowId) {
      ...
      viewContent.innerHTML = `
        <p><strong>Case #:</strong><strong>#${e.caseNo}</strong></p>
        <p><strong>Date & Time:</strong><strong>${new Date(e.incidentDate).toLocaleString()}</strong></p>
        <p><strong>Complainant:</strong> <strong>${escapeHtml(e.complainant)}</strong></p>
        <p><strong>Respondent:</strong> <strong>${escapeHtml(e.respondent || '—')}</strong></p>
        <p><strong>Location:</strong> <strong>${escapeHtml(e.location)}</strong></p>
        <p><strong>Type:</strong> <strong>${escapeHtml(e.incidentType)}</strong></p>
        <p><strong>Narrative:</strong> <strong>${escapeHtml(e.narrative || '—')}</strong></p>
      `;
